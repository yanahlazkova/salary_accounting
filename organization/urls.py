...
urlpatterns = [
    ...
    path('ustanova/<slug:kpk>/<slug:department>', DepartmentDetailView.as_view(), name='view_department'),
    path('ustanova/<slug:kpk>/edit/<slug:department>', DepartmentEditView.as_view(), name='edit_department'),
