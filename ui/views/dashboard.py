...
class UIDashboardView(HTMXTemplateMixin, TemplateView):
    ...
    page_content: tuple[str] = ('base_form_dashboard.html', 'base_table.html',)
    ...
    def get_obj_fields(self):
        ...
        fields_to_check = self.obj_fields or [f.name for f in self.obj_model._meta.fields if f.name != ('time_created' or 'time_updated')]
